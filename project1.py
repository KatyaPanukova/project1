# Напишите программу,которая вычисляет сколько денег жители Лапландии тратят на сигареты маркок: "Parlament","Senator","Belomor canal", в неделю ,в месяц ,в год в стране, c населением 42, и сколько впоследствии никотина потребляет житель в год.
#Известно, что 13 курят "Parlament", 18 - "Senator", 1 - "Belomor canal", а остальное население не курит вообще.Причем ,каждый выкуривает не менее 1 сигареты в день(из курящих).
#Также есть информация, что люди,курящие "Parlament", курят x сигарет в день, люди,курящие "Senator", курят y сигарет в день,люди,курящие "Belomor canal", курят z сигарет в день.
#Параметры x, y, z ввдятся пользователем. Стоимость сигарет :"Parlament"- 189 тугриков,"Senator"- 150,'Belomor canal'- 73. В пачке 20 сигарет.
##Программа должна выводить самый дешевый вариант в долгосрочном периоде,количество полученного за этот период никтоина в неделю, месяц,год,количество потраченных тугриков за неделю,месяц,год, и общую сумму расходов на сигареты за день, месяц, год.
import math
